...
public class MainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.INSTANCE.drawCenteredString("太阳客户端", this.width / 2 - 0.25F, this.height / 2 - 18, new Color(30, 30, 30, 70).getRGB());
        FontManager.INSTANCE.drawCenteredString("太阳客户端", this.width / 2, this.height / 2 - 19, -1);
        ...
        FontManager.INSTANCE.drawString("太阳客户端 1.12.2 ("+ Sun.version +"/master)", 7, this.height - 11, new Color(255, 255, 255, 100).getRGB());
        FontManager.INSTANCE.drawString(s, this.width - FontManager.INSTANCE.getStringWidth(s) - 6, this.height - 11, new Color(255, 255, 255, 100).getRGB());
