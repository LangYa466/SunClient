...
import cn.langya.sun.event.impl.game.*;
import cn.langya.sun.event.impl.network.PacketReceiveEvent;
import cn.langya.sun.event.impl.network.PacketSendEvent;
import cn.langya.sun.event.impl.player.*;
import cn.langya.sun.event.impl.render.*;
 ...
 * @since 04/18/2022
 */
public abstract class ListenerAdapter extends Utils implements EventListener  {
